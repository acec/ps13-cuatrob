		...
		<table class="table">
			...
			foreach ($carritos as $registro)
			{
				$this->_html .= '
					...
					<td class="item" style="text-align:left;">'.htmlentities($customers[intval($registro['id_customer'])]['firstname'], ENT_COMPAT, 'UTF-8').' '.htmlentities($customers[intval($registro['id_customer'])]['lastname'], ENT_COMPAT, 'UTF-8').'</td>
